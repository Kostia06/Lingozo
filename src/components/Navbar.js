  ...
  return (
    <>
      ...
      >
        ...
        <div className={`${!isOpen ? 'p-0' : 'p-4'} pb-safe border-t border-gray-700/50 bg-gray-800/50 backdrop-blur-md`}>
          {isOpen ? (
      ...
      {showNewChatModal && (
        ...
        >
          <motion.div
            ...
            className="bg-gray-900/95 backdrop-blur-2xl rounded-3xl p-6 sm:p-8 w-full max-w-md shadow-2xl border border-white/10"
          >
            <h3 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-purple-400 to-violet-400 bg-clip-text text-transparent mb-6">
            ...
            <div className="space-y-5">
              ...
              <div className="flex gap-3 pt-3">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="flex-1 bg-gradient-to-r from-purple-600 to-violet-600 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg hover:shadow-purple-500/30 transition-all"
                >
                  Create
                </motion.button>
                <motion.button
