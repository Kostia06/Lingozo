...
export default function SignupPage() {
  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-slate-900 to-black py-12 px-4 relative overflow-hidden">
        <Particles
        ...
        <BlurFade delay={0.1} inView>
          <div className="relative rounded-3xl overflow-hidden w-full max-w-md">
            <ShineBorder
              shineColor={["#22c55e", "#10b981", "#34d399"]}
              borderWidth={2}
              duration={10}
            />
            <div className="bg-gray-900/95 backdrop-blur-2xl rounded-3xl p-8 text-center">
              <motion.div
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-white/40 z-10" />
                    <input
                      id="fullName"
                      name="fullName"
                      type="text"
